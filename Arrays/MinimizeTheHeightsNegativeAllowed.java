/**
 * 
 * Assume that heights of the tower can be negative.
 * https://practice.geeksforgeeks.org/problems/minimize-the-heights-i/1/#  ---> qns
 * 
 * 
...
public class MinimizeTheHeightsNegativeAllowed {
    ...
    int getMinDiff(int[] arr, int n, int k) {
        ...
        for(int i=1;i<=n-1;i++)
        {
            // we consider ith element as current element and all (i-1) ele as previous and we add 'k' to previous ele and subtract 'k' from current ele and next elements.
            // we compare for largest ele with arr[n-1] and for smallest ele with arr[0].
