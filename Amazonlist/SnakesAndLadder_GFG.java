 ...
 * 
 * Here, we consider each cell as one node (directed) and we every cell is connected to 6-adjacent cells, if there is no snake or ladder.
 * If there is snake or ladder the every cell connects to 6-cells but all the cells need not be adjacent.
 * 
